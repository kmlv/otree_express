...
class Constants(BaseConstants):
    ...
    emo_list_pg1 = emo_list[:num_emo_pg1]
    #print('len1', num_emo_pg1)
    num_emo_pg2 = emo_list_size - num_emo_pg1
    emo_list_pg2 = emo_list[num_emo_pg2:]
    #rint('len2', num_emo_pg2)


class Subsession(BaseSubsession):
    def before_session_starts(self):
        print(Constants.emo_list_pg1)
...
class Player(BasePlayer):
    ...
    for i in range(len(Constants.emo_list_pg1)):
        temp = '_'.join(Constants.emo_list_pg1[i])
    ...
    for i in range(len(Constants.emo_list_pg2)):
        temp = '_'.join(Constants.emo_list_pg2[i])
        locals()['{}'.format(temp)] = models.DecimalField(widget=widgets.HiddenInput(),
                                                          max_digits=3,
                                                          decimal_places=1,
                                                          min=1,
